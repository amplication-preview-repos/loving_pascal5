...
const service = {
  ...
  profilePictures: () => FIND_MANY_RESULT,
  profilePicture: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("ProfilePicture", () => {
  ...
  test("POST /profilePictures", async () => {
  ...
  test("GET /profilePictures", async () => {
    await request(app.getHttpServer())
      .get("/profilePictures")
  ...
  test("GET /profilePictures/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/profilePictures"}/${nonExistingId}`)
  ...
  test("GET /profilePictures/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/profilePictures"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /profilePictures existing resource", async () => {
