...
@InputType()
class ProfilePictureUpdateInput {
  @ApiProperty({
    required: false,
  })
  @IsJSONValue()
  ...
  @ApiProperty({
    required: false,
    type: () => UserUpdateManyWithoutProfilePicturesInput,
  })
  @ValidateNested()
  @Type(() => UserUpdateManyWithoutProfilePicturesInput)
  @IsOptional()
  @Field(() => UserUpdateManyWithoutProfilePicturesInput, {
    nullable: true,
  })
  users?: UserUpdateManyWithoutProfilePicturesInput;
}

export { ProfilePictureUpdateInput as ProfilePictureUpdateInput };
